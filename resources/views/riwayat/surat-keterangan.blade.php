<x-history-layout>
        ...
        <section class="detail-header-section">
            ...
            <div class="container">
                <nav class="breadcrumb">
                    ...
                    <span class="separator">></span>
                    <span class="current">Surat Keterangan</span>
                </nav>
        ...
        <section class="nomor-acara-section">
            <div class="container">
                <div class="section-header">
                    ...
                    <p>Pilih nomor acara untuk melihat surat keterangan</p>
                </div>
                ...
                <div class="nomor-acara-list" id="nomorAcaraList">
                    ...
                    <div class="nomor-acara-item" data-acara="{{ strtolower($acara) }}">
                        ...
                        <div class="acara-actions">
                            <a href="{{ route('riwayat.peraih-sk', ['eventId' => $kejuaraan['id'], 'nomorAcara' => urlencode($acara)]) }}" class="btn-view-sk">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Animate items on load with staggered effect
