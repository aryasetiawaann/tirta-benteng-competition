<x-history-layout>
        ...
        <section class="detail-header-section">
            ...
            <div class="container">
                <nav class="breadcrumb">
                    ...
                    <span class="separator">></span>
                    <a href="{{ route('riwayat.surat-keterangan', $kejuaraan['id']) }}">
        ...
        <section class="winners-section">
            <div class="container">
                <div class="winners-container horizontal">
                    ...
                    <div class="winner-card horizontal sk-card" data-rank="{{ $winner['peringkat'] }}">
                        <div class="card-left">
                        ...
                        <div class="card-content">
                            ...
                            <div class="winner-actions horizontal">
                                <a href="{{ route('riwayat.view-surat-keterangan', ['eventId' => $kejuaraan['id'], 'nomorAcara' => urlencode($nomorAcara)]) }}" class="btn-view-sk" target="_blank">
                                    <i class="bx bx-show"></i>
                                    <span>Lihat</span>
                                </a>
                                <a href="{{ route('riwayat.view-surat-keterangan', ['eventId' => $kejuaraan['id'], 'nomorAcara' => urlencode($nomorAcara)]) }}" class="btn-download-sk" download>
                ...
                <div class="back-section">
                    <a href="{{ route('riwayat.surat-keterangan', $kejuaraan['id']) }}" class="btn-back">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Animate winner cards with slide-in effect
